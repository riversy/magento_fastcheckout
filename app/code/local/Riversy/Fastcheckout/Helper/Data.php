<?php
class Riversy_Fastcheckout_Helper_Data extends Mage_Core_Helper_Abstract
{
    ...
    {
        return Mage::getStoreConfig('fastcheckout/options/min_price');
    }

    public function confTax()
    {
        return Mage::getStoreConfig('fastcheckout/options/tax');
    }

    public function confExpressEnabled()
    {
        return Mage::getStoreConfig('fastcheckout/options/express_enable');
    }

    public function confExpressPrice()
    {
        return Mage::getStoreConfig('fastcheckout/options/express_price');
    }
    ...
    {
        return Mage::getStoreConfig('fastcheckout/a1pay_a1paymodel/is_debug');
    }
}