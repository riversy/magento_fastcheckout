<?php
class Riversy_Fastcheckout_Block_Oneclick_Form extends Mage_Core_Block_Template
{
    const TYPE_LOCAL = 'local';
    const TYPE_OTHER = 'other';
    const TEMPLATE_LOCAL = 'fastcheckout/form/local.phtml';
    const TEMPLATE_OTHER = 'fastcheckout/form/other.phtml';
    ...
    {
        if ($data = Mage::helper('fastcheckout')->getFormData())
        {
            if (isset($data[$key]))
            {
                return $data[$key];
...
//        Mage::helper('fastcheckout')->setPrice( $totals['subtotal']->getValue().' руб.' );
    ...
    {
        return ( $this->getSubtotal() < Mage::helper('fastcheckout')->confDefaultMinPrice() );
    }
    
    public function getMinSubtotal()
    {
        return Mage::helper('fastcheckout')->confDefaultMinPrice();
    }
    
    public function getShippingCost()
    {
        return Mage::helper('fastcheckout')->confTax();
    }
}
